...
<!-- head YDC end -->
<form action="<%=basePath%>user/boundTel.action" name="myform" id="myform" method="post">
<div class="ydc-column ydc-column-8" style="width:800px;height: 500px;margin: auto;position: absolute;text-align: center;top: 0;left: 0;right: 0;bottom: 0;">
					...
					<div class="ydc-reg-form-group">
							<div class="ydc-reg-form-button" style="margin-left:255px;">
								<a class="btn fl" href="javascript:document.myform.submit();" id="sss"  onclick="return checkForm()">绑定手机号</a>
       ...
       $.ajax({					
			 ...
			 success:function(data){
				 if(data[0]==2){
					 ...
					 telspan.innerHTML="手机号已被使用".fontcolor("red");
					 $("#code").attr("disabled",true);
					 flag=false;
			           return false;
				 }
