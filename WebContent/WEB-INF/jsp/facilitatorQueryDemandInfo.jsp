				...
				<div class="ydc-release-content">
					<div class="ydc-tabPanel ydc-tabPanel-release">
						...
						<div class="ydc-panes">
								...
								<div class="aui-card-form-item">
											<label class="aui"><a href="<%=path %>user/print.action?url=${contract.contractPath}&page=redirect:/demand/queryDemandInfo.action?demandid=${demandInfo.demandId}"   class=" btn btn-warning illegalBtn rightSize"  type="button"  data-id=${list.productionId } id="illegal">打印合同</a></label>
								</div>
								</c:if>
