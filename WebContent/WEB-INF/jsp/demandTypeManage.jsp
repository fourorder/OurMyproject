...
<div style="height: 50%;width: 95%; margin:0 auto;">
  需求类型：<input type="text" id="query" /><button onclick="query()"><span class="layui-btn layui-btn-normal">查询</span></button>
...
<table class="layui-table">
  ...
  <td><a class="layui-btn layui-btn-sm layui-btn-danger" id="yyy" href="#"  onclick="changeState(${demandType.parameterId},${num});return false;" >删除</a></td>
  </tr>
  </c:forEach>
  </tbody>
  <tr>
