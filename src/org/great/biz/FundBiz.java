...
public interface FundBiz {
	...
	public List<FundBean> getFundList3(String page,int userid);//账户管理（陈毅）
	...
	public List<Object> selectFund3(String page,String state,int userid);//账户管理（陈毅）
	
	public int getcountPage();
	public int getcountPage2(int userid);//账户管理(陈毅)
	public int getcountPage3(int userid);//账户管理(陈毅)
